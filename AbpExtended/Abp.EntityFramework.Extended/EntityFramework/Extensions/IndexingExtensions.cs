...
{
    /// <summary>
    /// Copy code from https://github.com/mj1856/EntityFramework.IndexingExtensions/blob/master/EntityFramework.IndexingExtensions/IndexingExtensions.cs
    /// </summary>
    public static class IndexingExtensions
    {
            ...
            where TEntity : class
        {
            ...
            for (var i = 0; i < additionalPropertySelectors.Length; i++)
            {
